...
namespace EChallanSystem.Models
{
    public class ApplicationDbContextSeed
    {
        public static async Task SeedEssentialsAsync(UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager)
        {
            ...
            await roleManager.CreateAsync(new IdentityRole(Authorization.Roles.Citizen.ToString()));
            await roleManager.CreateAsync(new IdentityRole(Authorization.Roles.TrafficWarden.ToString()));
            //Seed Default User
